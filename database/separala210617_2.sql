...
select * from d_canchas_negocio where n_cod_neg = (select n_cod_neg from p_usuario_negocio where n_cod_usu = 1);
...
select "Nombre" title, d_fech_ini_even start, d_fech_fin_even end, c_color_even color, c_icon_even icon
 from deventos where n_cod_neg = pa_n_cod_neg;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
-- Dump completed on 2017-06-21 22:25:51
