...
select ev.n_cod_event id,ev.n_cod_neg, ev.n_cod_cancha ,CONCAT( dc.c_desc_cancha," - " ,ev.c_desc_even) title,ev.d_fech_ini_even start, ev.d_fech_fin_even end, ev.c_color_even color, ev.c_icon_even icon
 from deventos ev
...
-- Dump completed on 2017-07-02 20:29:18
