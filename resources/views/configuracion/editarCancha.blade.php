                        ...
                        <div class="row">
                            ...
                            <section>
                                <label class="textarea">Descripción: <i class="icon-append fa fa-comment"></i>
                                    <textarea rows="2" id="descriptiondata1" maxlength="40" name="descriptiondata1" placeholder="Máximo 120 caracteres" ></textarea>
                                </label>
                            </section>
                            ...
                            <div class="row">
                                <section class="col col-4">
                                    ...
                                    <label class="input"> <i class="icon-append fa fa-calendar"></i>
                                        <input type="text" name="fechaEvento1" id="fechaEvento1" placeholder="Select a date" class="form-control datepicker" data-dateformat="yy/mm/dd" value="">
                                    </label>
                                </section>
                                <section class="col col-4">
                                    <label class="label">Hora:</label>
                                    <label class="input"> <i class="icon-append fa fa-clock-o"></i>
                                    <input class="form-control" id="horaEvento1" name="horaEvento1" type="text" placeholder="Select time" value="">
                                        </label>
                                </section>
                                <section class="col col-4">
                                    <label class="label">Tiempo(horas):</label>
                                    <label class="input">
                                        <input class="form-control spinner-rigth"  name="tiempoEvento1" id="tiempoEvento1" name="spinner" type="text" value="">
                                    </label>
                                </section>
                            </div>
